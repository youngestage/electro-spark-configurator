            ...
            <div className="lg:col-span-2">
              ...
              <div className="space-y-3">
                <div className="flex items-center text-secondary-foreground/80">
                  ...
                  <span>talk2drill@gmail.com</span>
                </div>
                <div className="flex items-center text-secondary-foreground/80">
                  <Phone className="h-4 w-4 mr-3" />
                  <span>08022233310, 07032402454</span>
                </div>
                <div className="flex items-center text-secondary-foreground/80">
                  <MapPin className="h-4 w-4 mr-3" />
                  <span>Windelectric factory adeyi street Ago-ika enu gada lafenwa abeokuta Ogun state</span>
                </div>
              </div>
            </div>
